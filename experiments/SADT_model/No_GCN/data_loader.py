...
class EEGDataLoader:
    ...
    def __init__(self, root_path, subjects=23, sample_key='sample', label_col='CLASS'):
        self.root = root_path
    ...
    def _load(self):
        ...
        for sid in self.subject_ids:
            ...
            if n_class_0 < 50 or n_class_1 < 50:
            ...
            # 统计维度为 (样本数, 时间步, 频段)，为每个(H,W)位置计算均值和标准差
        ...
        if excluded_subjects_info:
            print(
                f"  - Excluded {len(excluded_subjects_info)} subjects who did not meet the criteria (min samples per class: 50):")
...
class EEGDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        # 修改点：移除Z-score步骤，直接使用 x_hw_sample
